...
const examples = [
  { emoji: "📵", title: "7 días sin TikTok", meta: "Vida digital · 7 días", signal: "Concentración" },
  { emoji: "🌙", title: "Sin móvil después de las 23:00", meta: "Sueño · 14 días", signal: "Calidad del sueño" },
  { emoji: "🧠", title: "Deep Work 50/10", meta: "Productividad · 10 días", signal: "Productividad" },
  { emoji: "💸", title: "Regla de las 24 horas", meta: "Dinero · 14 días", signal: "Control del gasto" },
];
    ...
    <main className="landing labbook-landing">
      ...
      <section className="hero shell lab-hero">
        ...
        <div className="lab-specimen-wrap" aria-label="Ejemplo de resultado de Itera">
          <div className="specimen-index"><span>SPECIMEN / 07</span><span>LIVE SAMPLE</span></div>
          <article className="lab-specimen">
            ...
            <div className="specimen-readout">
              <div className="specimen-signal"><small>SEÑAL</small><strong>+21%</strong><span>calidad del sueño</span></div>
              <div className="specimen-scale"><div><small>ANTES</small><strong>6.2</strong></div><span>→</span><div><small>DURANTE</small><strong>7.5</strong></div></div>
            </div>
            ...
            <div className="specimen-foot"><span>N=7 CHECK-INS</span><span>DATOS AUTODECLARADOS</span></div>
          </article>
        </div>
      </section>
      ...
      <section className="examples shell lab-section">
        <div className="section-heading row-heading">
          ...
          <Link href="/app/discover" className="text-link">Explorar 24 pruebas →</Link>
        </div>
      ...
      <footer className="landing-footer shell"><span>itera / labbook</span><span>Prueba · Mide · Decide</span><span>v0.3</span></footer>
    </main>
  );
}
